...
},{"./view/DefaultTemplate":197}],186:[function(require,module,exports){
"use strict";
...
var _viewTemplate = require("./view/Template");
...
var _utilPubSub = require("./util/PubSub");

var _utilPubSub2 = _interopRequireDefault(_utilPubSub);

var _utilConfigDB = require("./util/ConfigDB");

var _utilConfigDB2 = _interopRequireDefault(_utilConfigDB);
...
exports.
// model
ColorUtil = _modelColorUtil2["default"];
exports.Color = _modelColor2["default"];
exports.Palette = _modelPalette2["default"];
exports.Model = _modelModel2["default"];
exports.ModelEventListener = _modelModelEventListener2["default"];
exports.

// controller
Controller = _controllerController2["default"];
exports.

// view
View = _viewView2["default"];
exports.Template = _viewTemplate2["default"];
...
exports.PubSub = _utilPubSub2["default"];
exports.ConfigDB = _utilConfigDB2["default"];
exports.

// main
DEFAULT_CONFIG = _DefaultConfig2["default"];
exports.PCP = _PCP2["default"];

},{"./DefaultConfig":185,"./PCP":187,"./controller/Controller":188,"./model/Color":189,"./model/ColorUtil":190,"./model/Model":191,"./model/ModelEventListener":192,"./model/Palette":193,"./util/ConfigDB":194,"./util/PubSub":195,"./util/Util":196,"./view/DefaultTemplate":197,"./view/DummyTemplate":198,"./view/Template":199,"./view/View":200}],187:[function(require,module,exports){
"use strict";
...
var PCP = (function () {
	function PCP(config) {
		...
		this._model = new _modelModel2["default"]();
		this._controller = new _controllerController2["default"](this._model);
		this._view = new _viewView2["default"](this._config.query("id"), this._controller, this._config.query("template"));
	...
	_createClass(PCP, [{
		...
		value: function run() {
			...
			Object.keys(this._config.actions).forEach(function (key) {
				_this2._config.exec(key);
			});
		}
	}, {
		key: "subscribe",
		value: function subscribe(onPaletteColorsSet, onSelectorColorsSet, onPaletteColorChanged) {
			return this._controller.exec("subscribe", onPaletteColorsSet, onSelectorColorsSet, onPaletteColorChanged);
		}
	}, {
		key: "unsubscribe",
		value: function unsubscribe(tokens) {
		...
		value: function _createConfig() {
			...
			var dc = _DefaultConfig2["default"];
			var c = new _utilConfigDB2["default"]();
			c.append("id", dc["id"], function () {
				_this3._view.domId = _this3._config.query("id");
			});
			c.append("palette", dc["palette"], function () {
				_this3._controller.exec("setPaletteColors", _this3._config.query("palette"));
			});
			c.append("selector", dc["selector"], function () {
				_this3._controller.exec("setSelectorColors", _this3._config.query("selector"));
			});
			c.append("template", dc["template"], function () {
				_this3._view.template = _this3._config.query("template");
			});
			return c;
		}
	}]);
...
},{"./DefaultConfig":185,"./controller/Controller":188,"./model/Model":191,"./util/ConfigDB":194,"./view/View":200}],188:[function(require,module,exports){
"use strict";
	...
	_createClass(Controller, [{
		...
		value: function exec(command) {
			if (this.model[command] instanceof Function) {
				...
				return _utilUtil2["default"].deepClone(this.model[command]);
...
},{"../util/Util":196}],189:[function(require,module,exports){
"use strict";
...
},{"./ColorUtil":190}],190:[function(require,module,exports){
"use strict";
...
var Model = (function () {
	function Model(paletteColors, selectorColors, listener) {
		...
		this.broadcaster = new _utilPubSub2["default"]();
	...
	_createClass(Model, [{
		...
		value: function setPaletteColors(colors) {
			...
			if (this.listener) {
				var copy = _utilUtil2["default"].deepClone(this.palette);
		...
		value: function setSelectorColors(colors) {
			...
			if (this.listener) {
				var copy = _utilUtil2["default"].deepClone(this.selector);
...
},{"../util/PubSub":195,"../util/Util":196,"./Palette":193}],192:[function(require,module,exports){
"use strict";
...
},{"./Color":189}],194:[function(require,module,exports){
"use strict";
...
var _babelifyPolyfill = require("babelify/polyfill");

// make it support ES6 feature - Symbol on all platforms.
	...
	_createClass(PubSub, [{
		...
		value: function publish(topic) {
			...
			for (var i = 0; i < subscribers.length; i++) {
				...
				(_subscribers$i = subscribers[i]).doSomething.apply(_subscribers$i, msg);
			}
			return true;
		}
...
},{"babelify/polyfill":183}],196:[function(require,module,exports){
"use strict";
		...
		function cloneHelper(target, source) {
			for (var key in source) {
				...
				if (descriptor.value instanceof String) {
					...
					var _prototype = Reflect.getPrototypeOf(descriptor.value);
					var cloneObject = cloneHelper({}, descriptor.value);
					Reflect.setPrototypeOf(cloneObject, _prototype);
...
},{"../model/ColorUtil":190,"./Template":199}],198:[function(require,module,exports){
"use strict";
...
},{"./Template":199}],199:[function(require,module,exports){
"use strict";
...
},{"../model/ModelEventListener":192}],200:[function(require,module,exports){
"use strict";
...
},{"../model/ModelEventListener":192}]},{},[186])(186)
});
